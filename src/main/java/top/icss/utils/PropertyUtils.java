...
public class PropertyUtils {
     ...
     */
    public static final String COMMON_PROPERTIES_PATH = "server.properties";
    ...
    public static synchronized void loadPropertyFile(String... propertyFiles) {
        for (String fileName : propertyFiles) {
            try{
                ...
                try (InputStream fis = PropertyUtils.class.getClassLoader().getResourceAsStream(fileName);) {
                    properties.load(fis);
